...
object FinancialDataHIP {
  implicit val reads: Reads[FinancialDataHIP]    = Json.reads[FinancialDataHIP]
...
object Totalisation {
  ...
  implicit val writes: OWrites[Totalisation] = (
...
object DocumentDetails {
  ...
  implicit val reads: Reads[DocumentDetails] = Json.reads[DocumentDetails]

  implicit val writes: OWrites[DocumentDetails] = (
