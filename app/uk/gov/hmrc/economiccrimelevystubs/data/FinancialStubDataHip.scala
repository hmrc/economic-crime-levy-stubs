...
object FinancialStubDataHip {
  ...
  def financialDataDueObligation(): FinancialDataHIP = FinancialDataHIP(
    Some(
      Totalisation(
  ...
  def financialDataPaidObligationResponse(): FinancialDataHIP = FinancialDataHIP(
    Some(
      Totalisation(
        totalAccountBalance = Some(1250),
        totalAccountOverdue = Some(1000),
  ...
  def financialDataPartiallyPaidResponse(): FinancialDataHIP = FinancialDataHIP(
    Some(
      Totalisation(
        totalAccountBalance = Some(1250),
        totalAccountOverdue = Some(1000),
  ...
  def financialDataPaidPartiallyPaidOverdueResponse(): FinancialDataHIP = FinancialDataHIP(
    Some(
      Totalisation(
        totalAccountBalance = Some(1250),
        totalAccountOverdue = Some(1000),
  ...
  def financialDataOverpaidObligationSinglePayment(): FinancialDataHIP = FinancialDataHIP(
    Some(
      Totalisation(
        totalAccountBalance = Some(1250),
        totalAccountOverdue = Some(1000),
  ...
  def financialDataOverpaidObligationMultiplePayments(): FinancialDataHIP = FinancialDataHIP(
    Some(
      Totalisation(
  ...
  def financialDataPaidObligationPartialPaidInterestResponse(): FinancialDataHIP = FinancialDataHIP(
    Some(
      Totalisation(
        totalAccountBalance = Some(1250),
        totalAccountOverdue = Some(1000),
  ...
  def financialDataOverdueObligationWithInterestResponse(): FinancialDataHIP = FinancialDataHIP(
    Some(
      Totalisation(
        totalAccountBalance = Some(1250),
        totalAccountOverdue = Some(1000),
  ...
  def financialDataPaidObligationPaidInterestResponse(): FinancialDataHIP = FinancialDataHIP(
    Some(
      Totalisation(
        totalAccountBalance = Some(1250),
        totalAccountOverdue = Some(1000),
  ...
  def financialDataRefundForOverpayment(): FinancialDataHIP = FinancialDataHIP(
    Some(
      Totalisation(
  ...
  def financialDataOverdueObligationWithoutInterestDocumentFormed(): FinancialDataHIP = FinancialDataHIP(
    Some(
      Totalisation(
  ...
  def financialDataUnexpectedDocumentType(): FinancialDataHIP = FinancialDataHIP(
    Some(
      Totalisation(
        totalAccountBalance = Some(1250),
        totalAccountOverdue = Some(1000),
  ...
  def financialDataPaidObligationWithReversalLineItemResponse(): FinancialDataHIP = FinancialDataHIP(
    Some(
      Totalisation(
        totalAccountBalance = Some(1250),
        totalAccountOverdue = Some(1000),
  ...
  def financialDataPaidChargeWithInterestAndReversalResponse(): FinancialDataHIP = FinancialDataHIP(
    Some(
      Totalisation(
  ...
  def financialDataClearingDocument(): FinancialDataHIP = FinancialDataHIP(
    Some(
      Totalisation(
        totalAccountBalance = None,
        totalAccountOverdue = None,
  ...
  def financialDataFirstLateFilingPenalty(): FinancialDataHIP = FinancialDataHIP(
    Some(
      Totalisation(
        totalAccountBalance = Some(1250),
        totalAccountOverdue = Some(1000),
  ...
  def financialDataFirstLatePaymentPenalty(): FinancialDataHIP = FinancialDataHIP(
    Some(
      Totalisation(
        totalAccountBalance = Some(1250),
        totalAccountOverdue = Some(1000),
  ...
  def financialDataSecondLateFilingPenalty(): FinancialDataHIP = FinancialDataHIP(
    Some(
      Totalisation(
        totalAccountBalance = Some(1250),
        totalAccountOverdue = Some(1000),
  ...
  def financialDataPaymentOnAccount(): FinancialDataHIP = FinancialDataHIP(
    Some(
      Totalisation(
        totalAccountBalance = Some(1250),
        totalAccountOverdue = Some(1000),
