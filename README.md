...
|----------------------------|-------------------------------------------------------------------------------------------|--------------------------------------|
| XMECL0000000001            | A single open obligation that is due in the future                                        | Cleared obligation                   |
| XMECL0000000002            | Two open obligations; one that is due in the future and one that is overdue               | Cleared and outstanding obligation   |
| XMECL0000000003            | A single fulfilled obligation before the due date                                         |                                      |
| XMECL0000000004            | Two obligations; one fulfilled before the due date and one open that is due in the future |                                      |
| XMECL0000000005            | Three obligations; overdue, due and fulfilled                                             |                                      |
